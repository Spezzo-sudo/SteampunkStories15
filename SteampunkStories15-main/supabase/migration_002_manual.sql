...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE tablename = 'settlements' AND policyname = 'settlements_select_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'settlements' AND policyname = 'settlements_insert_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'settlements' AND policyname = 'settlements_update_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'ships' AND policyname = 'ships_select_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'ships' AND policyname = 'ships_insert_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'ships' AND policyname = 'ships_update_policy'
  ) THEN
...
-- ============================================
-- 3. CONVOYS TABLE (NEW - Military Operations)
-- ============================================
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'convoys' AND policyname = 'convoys_select_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'convoys' AND policyname = 'convoys_insert_policy'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'scout_reports' AND policyname = 'scout_reports_select_policy'
  ) THEN
